...
static void ras_report_aer_ipmi_init(void)
{
	...
	/*
	 * On Ampere Altra platforms we can use ipmitool (if installed).
	 * We verify only on startup if we are on this type of platfom,
	 * as the 'ipmitool fru' command takes time.
	 */
